...
class NewProductMainFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        rv_new_overview_new.adapter=productOverViewRecyclerViewAdapter
        rv_new_overview_new.layoutManager= GridLayoutManager(context!!,3)
        getNewProductListResponse()
    }
    private fun getNewProductListResponse(){
